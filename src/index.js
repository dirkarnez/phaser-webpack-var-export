...
class BackgroundScene extends Phaser.Scene
{
    ...
    preload ()
    {
        this.load.image('guide', 'https://labs.phaser.io/assets/tests/640x960-guide.png');
        this.load.image('bg', 'https://labs.phaser.io/assets/skies/bigsky.png');
        this.load.atlas('clouds', 'https://labs.phaser.io/assets/atlas/clouds.png', 'https://labs.phaser.io/assets/atlas/clouds.json');
